!(function () {
        ...
        et = e(function (t) {
            ...
            (t.exports = function (t, e, i, a) {
                ...
                'function' == typeof i &&
                    ...
                    t !== n
                        ? (u ? !c && t[e] && (s = !0) : delete t[e], s ? (t[e] = i) : I(t, e, i))
                        : s
                        ? (t[e] = i)
                        : T(e, i);
    ...
    var re =
        ...
        oe = function (t, e) {
            ...
            return (
                re(t) &&
                    ('function' != typeof (r = t.constructor) || (r !== Array && !re(r.prototype))
    ...
    var Le = { IteratorPrototype: Se, BUGGY_SAFARI_ITERATORS: ke },
        ...
        Me = Dt('toStringTag'),
        _e = function (t, e, r) {
            t && !b((t = r ? t : t.prototype), Me) && Ue(t, Me, { configurable: !0, value: e });
        },
        Ne = {},
        ...
        Be = function (t, e, r) {
            var n = e + ' Iterator';
            return (t.prototype = Ht(Ce, { next: c(1, r) })), _e(t, n, !1), (Ne[n] = Fe), t;
        },
        De = function (t) {
        ...
        Mr = e(function (t) {
            ...
            (t.exports = function (t, r, n, o, i) {
                ...
                if (i) a = t;
                    ...
                    if (nr(u)) {
                        for (s = 0, c = ct(t.length); c > s; s++)
                            if ((f = o ? p(R((h = t[s]))[0], h[1]) : p(t[s])) && f instanceof e)
                                return f;
                        return new e(!1);
                    }
                    a = u.call(t);
                ...
                for (l = a.next; !(h = l.call(a)).done; )
                    if ('object' == typeof (f = tr(a, p, h.value, o)) && f && f instanceof e)
                        return f;
                return new e(!1);
            }).stop = function (t) {
                return new e(!0, t);
        ...
        Gr = {
            ...
            setStrong: function (t, e, r) {
                ...
                Xe(
                    ...
                    e,
                    function (t, e) {
                        Wr(this, { type: n, target: t, state: o(t), kind: e, last: void 0 });
                    },
                    function () {
    ...
    kt({ target: 'Map', proto: !0, real: !0, forced: D }, { upsert: cn }),
        kt({ target: 'Map', proto: !0, real: !0, forced: D }, { updateOrInsert: cn });
    var fn = '\t\n\v\f\r                　\u2028\u2029\ufeff',
        ln = '[' + fn + ']',
        hn = RegExp('^' + ln + ln + '*'),
        pn = RegExp(ln + ln + '*$'),
                ...
                Fr(s, {
                    ...
                    has: function (t) {
                        if (g(t) && !i(t)) {
                            var n = r(this);
                            return (
                                n.frozen || (n.frozen = new e()), f.call(this, t) || n.frozen.has(t)
                            );
                        }
        ...
        et(
            ...
            function () {
                ...
                return (
                    ...
                    e +
                    '/' +
                    String(void 0 === r && t instanceof RegExp && !('flags' in di) ? Yo.call(t) : r)
                );
            },
            { unsafe: !0 }
        );
            ...
            if (!a || !u || ('replace' === t && (!Ti || !ki || Ui)) || ('split' === t && !Mi)) {
                var s = /./[i],
                    c = r(
                        ...
                        { REPLACE_KEEPS_$0: ki, REGEXP_REPLACE_SUBSTITUTES_UNDEFINED_CAPTURE: Ui }
                    ),
                    f = c[1];
        ...
        return [
            ...
            function (t, n) {
                ...
                for (var g, y = '', m = 0, b = 0; b < d.length; b++) {
                    v = d[b];
                    for (
                        var w = String(v[0]), S = Bi(Di(ut(v.index), f.length), 0), E = [], x = 1;
                        x < v.length;
                        x++
                    )
                        ...
                        ? function (t, r) {
                              ...
                              for (
                                  ...
                                  !(
                                      ...
                                      i.length > 1 && i.index < n.length && Ki.apply(s, i.slice(1)),
                                      (u = i[0].length),
                                      (c = a),
                                      s.length >= o)
                                  );
            ...
            { target: 'Set', proto: !0, real: !0, forced: D },
            {
                isSubsetOf: function (t) {
                    var e = on(this),
                        ...
                        n = r.has;
                    return (
                        'function' != typeof n && ((r = new (ot('Set'))(t)), (n = Qt(r.has))),
                        !Mr(
                            e,
                            function (t) {
    ...
    var fa = bt.f,
        ...
        Fa = function (t, e) {
            ...
            return Sa(r, { type: ba, tag: t, description: e }), i || (r.description = e), r;
        },
        Ba = Nt
            ? function (t) {
                  return 'symbol' == typeof t;
        ...
        { target: 'String', stat: !0, forced: !!hu && 1 != hu.length },
        {
            fromCodePoint: function (t) {
                for (var e, r = [], n = arguments.length, o = 0; n > o; ) {
                    ...
                    r.push(
                        e < 65536 ? lu(e) : lu(55296 + ((e -= 65536) >> 10), (e % 1024) + 56320)
                    );
                }
                return r.join('');
            }
    ...
    kt(
        ...
        kt(
            { target: 'String', stat: !0 },
            {
                raw: function (t) {
                    for (
                        var e = v(t.raw), r = ct(e.length), n = arguments.length, o = [], i = 0;
                        r > i;
    ...
    var Ou = function (t) {
        ...
        Pu = ju
            ...
            : ''.trimStart;
    kt({ target: 'String', proto: !0, forced: ju }, { trimStart: Pu, trimLeft: Pu }),
        ee('String', 'trimLeft');
    var Iu = vn.end,
        Tu = Ou('trimEnd'),
        ku = Tu
            ...
            : ''.trimEnd;
    kt({ target: 'String', proto: !0, forced: Tu }, { trimEnd: ku, trimRight: ku }),
        ee('String', 'trimRight');
    var Lu = Dt('iterator'),
        Uu = !o(function () {
        ...
        ps = function () {
            ...
            var t,
                ...
                l = [];
            if (
                (Ju(f, { type: Xu, entries: l, updateURL: function () {}, updateSearchParams: fs }),
                void 0 !== c)
            )
                if (g(c))
    ...
    Fr(
        ds,
        {
            ...
            set: function (t, e) {
                ls(arguments.length, 1);
                for (
                    var r, n = Qu(this), o = n.entries, i = !1, a = t + '', u = e + '', s = 0;
                    s < o.length;
                    s++
                )
                    ...
                    case nc:
                        if (i && (Is.test(i) || '+' == i || '-' == i || '.' == i))
                            ...
                            if (
                                ...
                                return;
                            if (((t.scheme = l), r))
                                return void (Xs(t) && Hs[t.scheme] == t.port && (t.port = null));
                            (l = ''),
                                'file' == t.scheme
                                    ? (c = vc)
        ...
        (i &&
            zt(Oc, {
                ...
                search: Fc(_c, function (t) {
                    ...
                    '' == (t = String(t))
                        ? (e.query = null)
                        : ('?' == t.charAt(0) && (t = t.slice(1)), (e.query = ''), xc(e, t, Sc)),
                        ws(e.searchParams).updateSearchParams(e.query);
                }),
                searchParams: Fc(Nc),
                hash: Fc(Cc, function (t) {
                    var e = Es(this);
                    '' != (t = String(t))
                        ? ('#' == t.charAt(0) && (t = t.slice(1)), (e.fragment = ''), xc(e, t, Ec))
                        : (e.fragment = null);
                })
            }),
        et(
    ...
    (kl.polyfill = !0),
        self.fetch ||
            ((self.fetch = kl), (self.Headers = bl), (self.Request = Rl), (self.Response = Pl));
